			     ...
			     <div class="tab-grids">
                    <div id="tab1" class="tab-grid">  
						...
						<ol>							
                            ...
                            <li>
                                <input type="submit" class="submit" name="sub33"value="Recharge Now" />
                            </li>
				        </ol>
						</form>	
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<ol>							
							<li>
								...
								<input type="number" id="tel" name="tel" pattern="\d{10}" placeholder="Enter Mobile Number" required />
								<p class="validation01">
									<span class="invalid">Please enter a valid mobile number</span>
									<span class="valid">That's what we wanted!</span>
								</p>
				...
				<div>
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<ol>							
							<li>
								...
								<input type="number" id="tel" name="tel" pattern="\d{10}" placeholder="Enter Datacard Number" required />
								<p class="validation01">
                    ...
                    <div id="tab2" class="tab-grid">
						...
						<ol>	
                            ...
                            <li>
                            <input type="number" id="tel" name="con_num" pattern="\d{10}" placeholder="Enter consumer number Number" required />
                            <p class="validation01">
