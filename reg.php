                                    ...
                                    <div class="tab-pane active" id="Login">
                                        ...
                                        <div class="form-group">
                                            <label for="email" class="col-sm-2 control-label">
                                                Email</label>
                                            <div class="col-sm-10">
                                                <input type="email" name="email" class="form-control" id="email1" placeholder="Email" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" name="login" class="submit btn btn-primary btn-sm">
                                                    Submit</button>
                                    ...
                                    <div class="tab-pane" id="Registration">
                                        ...
                                        <div class="form-group">
                                            <label for="mobile" class="col-sm-2 control-label">
                                                Mobile</label>
                                            <div class="col-sm-10">
                                                <input type="tel" name="mobile" class="form-control" id="mobile" placeholder="Mobile" required="required" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="password"  class="col-sm-2 control-label">
                                                Password</label>
                                            <div class="col-sm-10">
                                                <input type="password" name="pass" class="form-control" id="password" placeholder="Password" required="required" />
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-10">
                                                <button type="submit" name="reg" class="submit btn btn-primary btn-sm">
