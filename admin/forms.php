...
<!-- ========== HEADER ========== -->
  ...
  <!-- ========== END HEADER ========== -->
                ...
                if(isset($_GET["phno"]))
                    {
                        $phno= $_GET["phno"];
                        $users="SELECT *FROM reg WHERE phno='$phno'";
                ...
                <div class="card">
                    <div class="card-body flex flex-col gap-6">
                        <h6 class="text-lg text-gray-500 font-semibold">Edit User</h6>
                        <div class="card">
                            <div class="card-body">
                            <form action="../register.php" method="post">
                                <div class="mb-6">
                                    ...
                                    <input type="email" name="email" value="<?=$user['email'];?>" id="input-label-with-helper-text"
                                ...
                                <div class="mb-6">
                                    <label for="input-label-with-helper-text"
                                        class="block text-sm mb-2 text-gray-400">Phone Number</label>
                                    <input type="hidden" name="phno" id="input-label-with-helper-text"value="<?=$user['phno'];?>"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="name" id="input-label-with-helper-text"value="<?=$user['name'];?>"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0 "
                                         aria-describedby="hs-input-helper-text">
                                </div>
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="pass" id="input-label-with-helper-text"value="<?=$user['pass'];?>"
                                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0 "
                                         aria-describedby="hs-input-helper-text">
                                </div>

                                  <button name="su3" class="btn text-base py-2.5 text-white font-medium w-fit hover:bg-blue-700">Submit</button>
                                </form>
                            </div>
                        </div>
