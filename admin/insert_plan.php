  ...
  <!-- ========== END HEADER ========== -->
                ...
                <div class="card">
                    <div class="card-body flex flex-col gap-6">
                        <h6 class="text-lg text-gray-500 font-semibold">Insert</h6>
                        <div class="card">
                            <div class="card-body">
                            <form action="../register.php" method="post">
                                <div class="mb-6">
                                    ...
                                    <input type="text" name="offer"  id="input-label-with-helper-text"
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="number" name="rs" id="input-label-with-helper-text"
                                ...
                                <div class="mb-6">
                                    <label for="input-label-with-helper-text"
                                        class="block text-sm mb-2 text-gray-400">vilidity</label>
                                    <input type="text" name="val" id="input-label-with-helper-text"\
                                        class="py-3 px-4 block w-full border-gray-200 rounded-sm text-sm focus:border-blue-600 focus:ring-0 "
                                         aria-describedby="hs-input-helper-text">
                                </div>
                               

                                  <button name="su6" class="btn text-base py-2.5 text-white font-medium w-fit hover:bg-blue-700">Insert</button>
                                </form>
                            </div>
                        </div>
